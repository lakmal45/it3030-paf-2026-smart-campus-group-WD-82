...
const ResourceAdminDashboard = () => {
  ...
  const fetchDashboardData = async () => {
    try {
      ...
      // Generate mock chart data
      setChartData([
        { time: 'Mon', available: 45, booked: 35 },
        { time: 'Tue', available: 52, booked: 38 },
        { time: 'Wed', available: 48, booked: 42 },
        { time: 'Thu', available: 61, booked: 39 },
        { time: 'Fri', available: 55, booked: 45 },
        { time: 'Sat', available: 67, booked: 23 },
        { time: 'Sun', available: 72, booked: 18 }
      ]);
    } catch (err) {
      console.error('Error fetching dashboard data:', err);
    } finally {
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 space-y-8 animate-in fade-in duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
        <div className="bg-gradient-to-br from-blue-50 to-blue-100/50 p-6 rounded-2xl border border-blue-200 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              ...
              <p className="text-xs text-blue-700 mt-1 font-medium">Active inventory</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-emerald-50 to-emerald-100/50 p-6 rounded-2xl border border-emerald-200 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-emerald-600 uppercase tracking-wider">Operational</p>
              <p className="text-3xl font-black text-emerald-900 mt-2">{stats.active}</p>
              <p className="text-xs text-emerald-700 mt-1 font-medium">Ready to use</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-amber-50 to-amber-100/50 p-6 rounded-2xl border border-amber-200 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-amber-600 uppercase tracking-wider">Maintenance</p>
              <p className="text-3xl font-black text-amber-900 mt-2">{stats.maintenance}</p>
              <p className="text-xs text-amber-700 mt-1 font-medium">Being serviced</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-rose-50 to-rose-100/50 p-6 rounded-2xl border border-rose-200 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-rose-600 uppercase tracking-wider">Out of Service</p>
              <p className="text-3xl font-black text-rose-900 mt-2">{stats.outOfService}</p>
              <p className="text-xs text-rose-700 mt-1 font-medium">Unavailable</p>
            </div>
        ...
        <div className="bg-gradient-to-br from-indigo-50 to-indigo-100/50 p-6 rounded-2xl border border-indigo-200 shadow-sm">
          <div className="flex items-start justify-between">
            <div>
              <p className="text-xs font-bold text-indigo-600 uppercase tracking-wider">Utilization</p>
              <p className="text-3xl font-black text-indigo-900 mt-2">{stats.utilization}%</p>
              <p className="text-xs text-indigo-700 mt-1 font-medium">Currently in use</p>
            </div>
      ...
      <div className="bg-white rounded-2xl border border-slate-200 p-6 shadow-sm">
        <div className="flex items-center justify-between mb-6">
          <h2 className="text-lg font-black text-slate-900">Recent Resources</h2>
          <Link to="/dashboard/manager/resources" className="text-blue-600 hover:text-blue-700 text-sm font-bold flex items-center gap-1">
            Manage All <ChevronRight className="h-4 w-4" />
          </Link>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
        ...
        <Link
          to="/dashboard/manager/resources"
          className="bg-gradient-to-br from-amber-50 to-amber-100/50 border border-amber-200 rounded-2xl p-6 hover:shadow-lg transition-shadow group"
        >
          <div className="flex items-start justify-between">
            <div>
              <h3 className="text-lg font-black text-slate-900 mb-2">Maintenance</h3>
              <p className="text-sm text-slate-600">Schedule and track</p>
            </div>
            <div className="p-3 bg-amber-200 group-hover:bg-amber-300 rounded-xl transition-colors">
              <Clock className="h-6 w-6 text-amber-600" />
            </div>
