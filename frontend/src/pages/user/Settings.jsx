...
import { Lock, Trash2, Bell, Sun, Moon, CheckCircle2, AlertTriangle, X, Loader2, KeyRound } from "lucide-react";
  ...
  return (
    <div className="p-4 sm:p-8 max-w-4xl mx-auto pb-20">
      <div className="mb-8">
        ...
        <p className="text-slate-500 mt-1">Manage your security, notifications, and preferences.</p>
      </div>
      ...
      <div className="space-y-8">
              ...
              <div className="p-6 bg-slate-50 rounded-2xl border border-slate-100 flex items-start gap-4">
                 ...
                 <div>
                    ...
                    <p className="text-sm text-slate-500 mt-1 leading-relaxed">
                      Your account is managed via Google Sign-In. Password management is handled by your Google Account settings.
                    </p>
        ...
        <section className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
          ...
          <div className="p-8 space-y-4">
             {[
               { id: 'email', title: 'Email Notifications', desc: 'Receive updates about your bookings and assignments via email.' },
               { id: 'push', title: 'Push Notifications', desc: 'Get real-time browser alerts when there are important updates.' },
               { id: 'maintenance', title: 'Maintenance Alerts', desc: 'Notify me about scheduled system maintenance and downtime.' }
             ].map((pref) => (
                <div key={pref.id} className="flex justify-between items-center p-4 rounded-2xl hover:bg-slate-50 transition-colors group">
                   ...
                   >
                      <div className={`absolute top-1 w-4 h-4 bg-white rounded-full transition-all duration-300 shadow-sm ${notifications[pref.id] ? 'left-7' : 'left-1'}`} />
                   </button>
                </div>
             ))}
          </div>
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-sm animate-fade-in">
           <div className="bg-white rounded-3xl max-w-md w-full p-8 shadow-2xl animate-scale-up border border-slate-100">
              ...
              <h3 className="text-2xl font-bold text-slate-800">Are you absolutely sure?</h3>
