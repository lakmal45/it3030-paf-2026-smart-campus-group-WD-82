  ...
  return (
    <div className="min-h-screen bg-[#F8FAFC] flex overflow-hidden font-sans selection:bg-indigo-500/30">
              ...
              {navigationLinks.map((item) => {
                ...
                return (
                  ...
                  >
                    ...
                    <Icon
                      size={20}
                      className={`transition-transform duration-300 group-hover:scale-110 ${isActive ? "text-indigo-600" : "text-slate-400 group-hover:text-slate-700"}`}
                    />
                    {item.name}
                  </Link>
                );
      ...
      <main className="flex-1 flex flex-col min-w-0 h-screen overflow-hidden z-10 relative">
        {/* Topbar */}
        <div className="z-30 transition-all sticky top-0 md:px-4 md:pt-4">
          <header className="h-20 flex items-center justify-between px-4 sm:px-8 bg-white/80 backdrop-blur-xl border border-white/50 shadow-[0_8px_30px_rgb(0,0,0,0.04)] md:rounded-3xl transition-all">
            ...
            <div className="flex items-center gap-3 sm:gap-5">
                ...
                <div className="relative" ref={notificationsDropdownRef}>
                  <button
                    ...
                    className={`p-2.5 hover:text-indigo-600 bg-white/80 backdrop-blur-sm hover:bg-white border ${
                      ...
                      isNotificationsOpen
                        ? "text-indigo-600 ring-2 ring-indigo-500/20 border-indigo-400"
                        : ""
                    }`}
                  >
                    <Bell
                      size={18}
                      className={`${unreadCount > 0 ? "text-indigo-600 animate-swing" : ""}`}
                    />
                    {unreadCount > 0 && (
                      <span
                        className="absolute -top-1.5 -right-1.5 flex h-5 w-5 items-center justify-center rounded-full bg-rose-500 text-[10px] font-bold text-white shadow border-2 border-white animate-bounce"
                      ...
                      {notifications.length > 0 ? (
                                ...
                                <div className="flex gap-4">
                                  ...
                                  <div className="flex-1 min-w-0">
                                    <div className="flex items-center justify-between gap-2">
                                      <h4
                                        className={`text-sm font-bold truncate ${notification.read ? "text-slate-700" : "text-indigo-900"}`}
                                      >
                                        {notification.title}
                                      </h4>
                                    ...
                                    <p
                                      className={`text-xs mt-1 leading-relaxed ${notification.read ? "text-slate-500 line-clamp-2" : "text-slate-600 font-medium line-clamp-2"}`}
                                    >
                        ...
                        <div className="py-12 flex flex-col items-center justify-center text-center px-6">
                          ...
                          <p className="text-xs text-slate-500 mt-1">
                            We'll alert you when there's something new happening
                            on campus.
                          </p>
                        </div>
                      )}
              ...
              <div className="relative" ref={profileDropdownRef}>
                ...
                >
                  ...
                  <ChevronDown
                    size={14}
                    className={`mr-1 text-slate-400 group-hover:text-slate-600 transition-all duration-300 ${isProfileOpen ? "rotate-180" : ""}`}
                  />
                </button>
